...
GenConfig = namedtuple('GenConfig', ['tests', 'R', 'P', 'C', 'L', 'E', 'N', 'F', 'random_partitions', 'random_leaders', 'random_configurations', 'allow_non_faulty_leaders', 'allow_quorumless_partitions', 'out_file'])
